...
- `skills/bom-cost-align`
  - EN: Align raw BOM spreadsheets with procurement cost sheets and generate formatted BOM cost workbooks with unit prices, totals, and component summaries.
  - 中文：将原始 BOM 与采购成本表自动对齐，生成含单价、价格和组件汇总的格式化 BOM 成本核算 Excel。
